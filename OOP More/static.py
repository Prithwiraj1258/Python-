...
class Shopping:
    ...
    @staticmethod #self diye jegulo declare kora hoy ekhane kisu accesable na
    def multiply(a, b):
        result = a*b
        print(result)
        # print(self.origin) not accesable in static method
        

    @classmethod
    def hudai_dekhi(self, item):
        print(self.name)#ekhane name instance attribute accessable na

        print(f'hudai dekhi {item} kintu kinmu just ac er hawa khaite aschi')
